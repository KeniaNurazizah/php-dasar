...
<head>
    ...
    <style>
        ...
        .container {
            ...
            padding: 30px;
            border-radius: 10px;
            box-shadow: 0 0 15px rgba(106, 13, 173, 0.2); /* Lavender shadow */
            margin-bottom: 20px;
        }
        .form-group label {
            font-size: 1.2rem;
        ...
        .form-control {
            font-size: 1.1rem;
            padding: 10px;
            border: 1px solid #6a0dad; /* Lavender border */
            border-radius: 5px;
        }
        .btn-primary {
            font-size: 1.2rem;
        ...
        .btn-primary:hover {
            background-color: #8a2be2; /* Darker lavender */
            border-color: #8a2be2;
        }
        .btn-secondary {
            font-size: 1.2rem;
            background-color: #d8bfd8; /* Light lavender */
            border-color: #d8bfd8;
            padding: 10px;
            color: black;
            border-radius: 5px;
        ...
        .btn-secondary:hover {
            background-color: #dda0dd; /* Medium lavender */
            border-color: #dda0dd;
        }
        table {
            width: 80%;
            ...
            margin: 20px auto;
            background: white;
            box-shadow: 0 0 10px rgba(106, 13, 173, 0.1); /* Lavender shadow */
        }
        table th, table td {
